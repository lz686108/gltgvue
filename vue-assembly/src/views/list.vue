<template>
  ...
  <div class="max">
    ...
    <!-- 表格 -->
    <dm_flex style="margin-top: 1.5vh">
      <dm_icon :icon="'genzong'" :value="'跟踪'" :row="'12'"> </dm_icon>
      <dm_icon :icon="'genzong'" :value="'跟踪'" :row="'12'"> </dm_icon>
    </dm_flex>
    <dm_flex style="margin-top: 0.8vh">
      <dm_slot :row="'12'"> </dm_slot>
      <dm_slot :row="'12'"> </dm_slot>
    </dm_flex>
    <dm_flex style="margin-top: 1.5vh">
      <dm_icon :icon="'genzong'" :value="'跟踪'" :row="'4'"> </dm_icon>
      <dm_icon :icon="'genzong'" :value="'跟踪'" :row="'4'"> </dm_icon>
      <dm_icon :icon="'genzong'" :value="'跟踪'" :row="'4'"> </dm_icon>
      <dm_icon :icon="'genzong'" :value="'跟踪'" :row="'4'"> </dm_icon>
      <dm_icon :icon="'genzong'" :value="'跟踪'" :row="'4'"> </dm_icon>
    ...
    <dm_flex style="margin-top: 0.8vh">
      ...
      <!-- <dm_slot :row="'24'"> </dm_slot> -->
      <!-- <dm_slot :row="'1'" id="echarts_1"> </dm_slot> -->
    </dm_flex>
  </div>
</template>
<script>
